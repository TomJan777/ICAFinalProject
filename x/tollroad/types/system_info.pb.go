...
// source: tollroad/system_info.proto
...
type SystemInfo struct {
	NextOperatorId uint64 `protobuf:"varint,1,opt,name=nextOperatorId,proto3" json:"nextOperatorId,omitempty"`
}
...
func (*SystemInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_f34493fece4e5a16, []int{0}
}
...
func (m *SystemInfo) GetNextOperatorId() uint64 {
	if m != nil {
...
func init() {
	proto.RegisterType((*SystemInfo)(nil), "b9lab.tollroad.tollroad.SystemInfo")
}

func init() { proto.RegisterFile("tollroad/system_info.proto", fileDescriptor_f34493fece4e5a16) }

var fileDescriptor_f34493fece4e5a16 = []byte{
	// 165 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *SystemInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.NextOperatorId != 0 {
		i = encodeVarintSystemInfo(dAtA, i, uint64(m.NextOperatorId))
		i--
		dAtA[i] = 0x8
	}
...
func (m *SystemInfo) Size() (n int) {
	...
	_ = l
	if m.NextOperatorId != 0 {
		n += 1 + sovSystemInfo(uint64(m.NextOperatorId))
	}
	return n
}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.NextOperatorId |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
