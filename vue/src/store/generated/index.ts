...
import B9LabTollRoadB9LabTollroadTollroad from './b9lab/toll-road/b9lab.tollroad.tollroad'
...
export default { 
  B9LabTollRoadB9LabTollroadTollroad: load(B9LabTollRoadB9LabTollroadTollroad, 'b9lab.tollroad.tollroad'),
